...
<Card className="rounded-lg mb-4 bg-gray-100 p-2 border-none shadow-none" onClick={() => navigate(`/product-detail/${productId}`)}>
 ...
 if (!products) return <p className="p-4 text-center ">Loading...</p>;
  ...
  return (
    <div className="container mx-auto p-4 mb-16">
        ...
        />
        <h2 className="flex-1 text-2xl text-center font-semibold">Products list</h2>
      </div>
